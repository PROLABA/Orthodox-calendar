...
import { DayComponent } from './calendarSwipers';



const ChangeServiceCalendar = () => {
    ...
    return (
        <div className="container" style={{ paddingTop: "24px" }}>
            <div className="month-container" style={{ display: 'flex', alignItems: 'center', gap: "64px" }}>
                <div className='month-head-nav'>
                    ...
                    <div style={{ fontSize: '18px', fontWeight: 'bold', minWidth: '150px', textAlign: "center" }}>
                ...
                <div className="helper-text " style={{ display: 'flex', gap: "16px" }}>
                    3rd Sunday After Pentecost/ The Sunday of All Saints of Russia/ Tone 2
                </div>
            </div>
...
export default ChangeServiceCalendar;